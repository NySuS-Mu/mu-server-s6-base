...
{
	int t = -1;
	t = g_CustomPet.GetPetType(NuevoPet - 1171);
	...
	*(float *)(a1 + 272) = -45.0;
	...
	if ( dwItemNumber < 1171 || dwItemNumber >= 2195 )
	{
		if(g_CustomPet.CheckCustomPetByItem(dwItemNumber - 1171))
		{
			...
			*(float *)(a1 + 268) = 180.0;
			*(float *)(a1 + 272) = 45.0;
			*(float *)(a1 + 96) = g_CustomPet.GetScaleDrop(dwItemNumber - 1171);
		}
	}
	return result;
}
...
int __cdecl ItemAngle(int a1)
{
  ...
  *(float *)(a1 + 272) = -45.0;
                        ...
                        switch ( *(_DWORD *)(a1 + 48) )
                        {
                          ...
                          default:
                            if ( *(_DWORD *)(a1 + 48) < 8385 || *(_DWORD *)(a1 + 48) > 8387 )
                            {
                              ...
                              else if ( *(_DWORD *)(a1 + 48) == 8389 )
                              {
                                *(float *)(a1 + 96) = 0.25999999;
                                *(float *)(a1 + 264) = 0.0;
                                *(float *)(a1 + 272) = 90.0;
                              }
                              else if ( *(_DWORD *)(a1 + 48) < 8371 || *(_DWORD *)(a1 + 48) > 8373 )
                              {
                                if ( *(_DWORD *)(a1 + 48) < 9530 || *(_DWORD *)(a1 + 48) > 9532 )
                                {
                                  if ( *(_DWORD *)(a1 + 48) < 7873 || *(_DWORD *)(a1 + 48) > 7875 )
                                  {
                                    if ( *(_DWORD *)(a1 + 48) == 8393 )
                                    {
                                      *(float *)(a1 + 96) = 0.5;
                                      *(float *)(a1 + 264) = 90.0;
                                    }
                                    else if ( *(_DWORD *)(a1 + 48) == 8397 )
                                    {
                                      *(float *)(a1 + 96) = 0.30000001;
                                      *(float *)(a1 + 272) = 90.0;
                                    }
                                    else if ( *(_DWORD *)(a1 + 48) != 8398 && *(_DWORD *)(a1 + 48) != 8399 )
                                    {
                                      if ( *(_DWORD *)(a1 + 48) != 8400 && *(_DWORD *)(a1 + 48) != 8401 )
                                      {
                                        if ( *(_DWORD *)(a1 + 48) == 8392 )
                                        {
                                          *(float *)(a1 + 96) = 0.2;
                                          *(float *)(a1 + 272) = 90.0;
                                        }
                                        else if ( *(_DWORD *)(a1 + 48) != 7870
                                               && *(_DWORD *)(a1 + 48) != 7871
                                               && *(_DWORD *)(a1 + 48) != 7872 )
                                        {
                                          if ( *(_DWORD *)(a1 + 48) < 8409 || *(_DWORD *)(a1 + 48) > 8410 )
                                          {
                                            if ( *(_DWORD *)(a1 + 48) < 8411 || *(_DWORD *)(a1 + 48) > 8416 )
                                            {
                                              if ( *(_DWORD *)(a1 + 48) == 7886 )
                                              {
                                                *(float *)(a1 + 96) = 0.2;
                                                *(float *)(a1 + 272) = 90.0;
                                              }
                                              else if ( *(_DWORD *)(a1 + 48) < 7881 || *(_DWORD *)(a1 + 48) > 7885 )
                                              {
                                                if ( *(_DWORD *)(a1 + 48) < 8417 || *(_DWORD *)(a1 + 48) > 8421 )
                                                {
                                                  switch ( *(_DWORD *)(a1 + 48) )
                                                  {
                                                    case 0x1ECF:
                                                    ...
                                                    case 0x20E6:
                                                      ...
                                                      *(float *)(a1 + 264) = 90.0;
                                                      break;
                                                    default:
                                                      if ( *(_DWORD *)(a1 + 48) < 8484 || *(_DWORD *)(a1 + 48) > 8489 )
                                                      {
                                                        if ( *(_DWORD *)(a1 + 48) < 7952 || *(_DWORD *)(a1 + 48) > 7954 )
                                                        {
                                                          switch ( *(_DWORD *)(a1 + 48) )
                                                          {
                                                            case 0x20EF:
                                                            ...
                                                            case 0x20ED:
                                                              ...
                                                              *(float *)(a1 + 272) = 90.0;
                                                              break;
                                                            default:
                                                              if ( *(_DWORD *)(a1 + 48) < 7889
                                                                || *(_DWORD *)(a1 + 48) > 7890 )
                                                              {
                                                                if ( *(_DWORD *)(a1 + 48) < 8436
                                                                  || *(_DWORD *)(a1 + 48) > 8437 )
                                                                {
                                                                  if ( *(_DWORD *)(a1 + 48) == 8479 )
                                                                  {
                                                                    *(float *)(a1 + 96) = 0.5;
                                                                    *(float *)(a1 + 272) = 90.0;
                                                                  }
                                                                  else if ( *(_DWORD *)(a1 + 48) == 8435 )
                                                                  {
                                                                    *(float *)(a1 + 96) = 0.2;
                                                                    *(float *)(a1 + 272) = 90.0;
                                                                  }
                                                                  else if ( *(_DWORD *)(a1 + 48) < 7891
                                                                         || *(_DWORD *)(a1 + 48) > 7892 )
                                                                  {
                                                                    if ( (*(_DWORD *)(a1 + 48) < 8394 || *(_DWORD *)(a1 + 48) > 8396)
                                                                      && (*(_DWORD *)(a1 + 48) < 8496 || *(_DWORD *)(a1 + 48) > 8498) )
                                                                    {
                                                                      switch ( *(_DWORD *)(a1 + 48) )
                                                                      {
                                                                        case 0x1EC4:
                                                                        ...
                                                                        case 0x1EC6:
                                                                          ...
                                                                          *(float *)(a1 + 96) = 0.44999999;
                                                                          break;
                                                                        default:
                                                                          if ( *(_DWORD *)(a1 + 48) != 8403 && *(_DWORD *)(a1 + 48) != 8492 )
                                                                          {
                                                                            switch ( *(_DWORD *)(a1 + 48) )
                                                                            {
                                                                              case 0x1EC7:
                                                                              ...
                                                                              case 0x2529:
                                                                                *(float *)(a1 + 264) = 90.0;
                                                                                break;
                                                                              default:
                                                                                if ( *(_DWORD *)(a1 + 48) != 9517 && *(_DWORD *)(a1 + 48) != 9518 )
                                                                                {
                                                                                  switch ( *(_DWORD *)(a1 + 48) )
                                                                                  {
                                                                                    case 0x252F:
                                                                                              ...
                                                                                              switch ( *(_DWORD *)(a1 + 48) )
                                                                                              {
                                                                                                ...
                                                                                                case 0x20A7:
                                                                                                  *(float *)(a1 + 272) = 45.0;
                                                                                                  break;
                                                                                                default:
                                                                                                  if ( *(_DWORD *)(a1 + 48) < 7848 || *(_DWORD *)(a1 + 48) > 7851 )
                                                                                                  {
                                                                                                    switch ( *(_DWORD *)(a1 + 48) )
                                                                                                    {
                                                                                                      case 0x1EB4:
                                                                                                      ...
                                                                                                      case 0x20BD:
                                                                                                        ...
                                                                                                        *(float *)(a1 + 96) = 1.3;
                                                                                                        break;
                                                                                                      default:
                                                                                                        if ( *(_DWORD *)(a1 + 48) != 8382 && *(_DWORD *)(a1 + 48) != 8383 )
                                                                                                        {
                                                                                                          if ( (*(_DWORD *)(a1 + 48) < 8870 || *(_DWORD *)(a1 + 48) > 8878) && *(_DWORD *)(a1 + 48) != 8490 && *(_DWORD *)(a1 + 48) != 8491 )
                                                                                                          {
                                                                                                            if ( *(_DWORD *)(a1 + 48) == 7893 )
                                                                                                            {
                                                                                                              *(float *)(a1 + 264) = 270.0;
                                                                                                              *(float *)(a1 + 96) = 1.0;
                                                                                                            }
                                                                                                            else if ( *(_DWORD *)(a1 + 48) == 8439 )
                                                                                                            {
                                                                                                              *(float *)(a1 + 264) = 180.0;
                                                                                                              *(float *)(a1 + 96) = 1.0;
                                                                                                            }
                                                                                                            else if ( *(_DWORD *)(a1 + 48) < 7910 || *(_DWORD *)(a1 + 48) > 7920 )
                                                                                                            {
                                                                                                              if ( *(_DWORD *)(a1 + 48) != 7924 && *(_DWORD *)(a1 + 48) != 7925 && *(_DWORD *)(a1 + 48) != 8430 && *(_DWORD *)(a1 + 48) != 8508 )
                                                                                                              {
                                                                                                                if ( *(_DWORD *)(a1 + 48) != 8449 && *(_DWORD *)(a1 + 48) != 8450 )
                                                                                                                {
                                                                                                                  switch ( *(_DWORD *)(a1 + 48) )
                                                                                                                  {
                                                                                                                    case 0x1EFE:
                                                                                                                    ...
                                                                                                                    case 0x1F0E:
                                                                                                                      ...
                                                                                                                      *(float *)(a1 + 264) = 30.0;
                                                                                                                      break;
                                                                                                                    default:
                                                                                                                      if ( *(_DWORD *)(a1 + 48) < 7315 || *(_DWORD *)(a1 + 48) >= 7827 )
                                                                                                                      {
                                                                                                                        v3 = 0;
                                                                                                                      }
                                                                                                                      else
  ...
  if ( v3 != 1 )
  {
    ...
    if ( *(_DWORD *)(a1 + 48) < 7962 || *(_DWORD *)(a1 + 48) > 7972 )
    {
      if ( *(_DWORD *)(a1 + 48) != 8499 && (result = a1, *(_DWORD *)(a1 + 48) != 8500) )
      {
        if ( sub_5C9370_Addr(*(_DWORD *)(a1 + 48) - 1171, 0) )
        {
          result = a1;
          *(float *)(a1 + 264) = 250.0;
          *(float *)(a1 + 268) = 180.0;
        ...
        else if ( (*(_DWORD *)(a1 + 48) < 4814 || *(_DWORD *)(a1 + 48) > 4816) && *(_DWORD *)(a1 + 48) != 4838 )
        {
          if ( *(_DWORD *)(a1 + 48) < 8881 || (result = a1, *(_DWORD *)(a1 + 48) > 8887) )
          {
            result = a1;
            if ( *(_DWORD *)(a1 + 48) < 8501 || *(_DWORD *)(a1 + 48) > 8502 )
            {
              *(float *)(a1 + 264) = 0.0;
            }
            else
  ...
  if(g_CustomPet.CheckCustomPetByItem(*(_DWORD *)(a1 + 48) - 1171))
  {
  	*(float *)(a1 + 264) = 270.0;
  	*(float *)(a1 + 268) = 180.0;
  	*(float *)(a1 + 272) = 45.0;
  	*(float *)(a1 + 96) = g_CustomPet.GetScaleDrop(*(_DWORD *)(a1 + 48) - 1171);
	result = a1;
  }
  else if(ItemTRSData.GetItemTRSData(*(_DWORD *)(a1 + 48) - 1171))
  {
	*(float *)(a1 + 264) = 270.0;
  	*(float *)(a1 + 268) = 180.0;
  	*(float *)(a1 + 272) = 45.0;
  	*(float *)(a1 + 96) = ItemTRSData.GetItemTRSDataScaleDrop(*(_DWORD *)(a1 + 48) - 1171);
	result = a1;
  }
//--------------------------------------------------------
  return result;
...
{
	int t = 0;
	t = g_CustomPet.GetInfoPetEffect(NuevoPet - 1171);
