...
void cOffTrade::DrawOffTradeWindowEx700(float x, float y)
{
	...
	for (int k = 0; k < 2; k++)
	{
		...
		for (int j = 0; j < 3; j++)
		{
			...
			if (pCheckMouseOver(Return2X(XButton), YButton, Return2X(TransForX(40)), 30))
			{
				Color = pMakeColor(220, 220, 220, 220);
			}
			
			RenderBitmap(51522, Return2X(XButton), YButton, Return2X(TransForX( 40 )), 17, 0.0, 0.0, 0.6235385537, 0.6235385537, 1, 1, 0);
