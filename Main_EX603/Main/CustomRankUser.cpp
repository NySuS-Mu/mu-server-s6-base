...
void CCustomRankUser::GCReqRankLevelUser(PMSG_CUSTOM_RANKUSER * aRecv)
{
	...
	memset(this->m_Data[aRecv->iIndex].m_MarryName, 0, sizeof(this->m_Data[aRecv->iIndex].m_MarryName));
	// ---
	...
	memcpy(this->m_Data[aRecv->iIndex].m_MarryName, aRecv->MarryName, sizeof(this->m_Data[aRecv->iIndex].m_MarryName));
}
