...
void CStatsAdvance::DrawInfo()
{
	...
	LoadBitmapA("Custom\\Interface\\StatsAdvanced.tga", 561020, 0x2601, 0x2900, 1, 0);
	...
	gElemental.gInfoBox(flDrawX, flDrawY+5, flWidth-10, flHight-15, 0x00000096, 0, 1.0);
	//gInterface.DrawFrame(31322, flDrawX, flDrawY, flWidth, flHight, 0.0, 0.0, 225, 270, flWidth, flHight, 0);
	...
	gInterface.DrawFormat(eGold, flDrawX, 5, flWidth, 3, "ADVANCED STATUS");
