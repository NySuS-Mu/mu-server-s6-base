...
public:
	...
	static void CGItemBuyRecvCallback(LPOBJ lpObj, BYTE slot, DWORD null, DWORD WCoinC, DWORD WCoinP, DWORD GoblinPoint,DWORD Ruud);
	...
	int GetInventoryItemSpace(LPOBJ lpObj, int index);
